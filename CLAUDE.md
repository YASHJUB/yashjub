...
**أقسام لوحة الإدارة لسه "قريباً" (placeholder بدون وظيفة فعلية):** الخدمات (كتالوج الخدمات الأربع لسه مكتوب بالكود مو بقاعدة بيانات)، المحادثات (الشات الحالي محلي بمتصفح العميل فقط، السيرفر ما يشوفه)، الإشعارات (ماكو نظام إشعارات بالمشروع أصلاً)، البلاغات والشكاوى (ماكو تقديم شكوى من جهة العميل بعد)، التقييمات (تقييم المزود بعد اكتمال الخدمة غير مُنفَّذ). كل وحدة من هذي تحتاج بناء نظام جديد من الصفر (غالباً يشمل صفحة/تدفق بجهة العميل أيضاً) قبل ما تصير صفحة الإدارة مفيدة فعلياً. (مركز العمليات المباشر صار مُنفَّذ فعلياً — راجع قسم "مركز العمليات المباشر" أعلاه.)
